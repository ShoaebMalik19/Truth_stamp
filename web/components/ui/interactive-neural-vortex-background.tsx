...
const InteractiveNeuralVortex = () => {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (uScrollProgress) gl.uniform1f(uScrollProgress, window.scrollY / (2 * window.innerHeight));
      
      gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4);
      (animationRef.current as unknown as number) = requestAnimationFrame(render);
    };
